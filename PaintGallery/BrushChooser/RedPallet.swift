...
class RedPallet: UIControl {
    
    private var _xRatio: CGFloat = 0.0;
...
//        typeLabel.text = "RED"
//        typeLabel.frame.origin.x = _selectorRect.origin.x;
//        typeLabel.frame.origin.y = _selectorRect.origin.y;
        
        CGContextSetFillColorWithColor(context, UIColor(red: 1 * _xRatio, green: 0, blue: 0, alpha: 1).CGColor)
    ...
    var selectorRect: CGRect {
        get{ return _selectorRect }
        set{ _selectorRect = newValue }
    }
}
